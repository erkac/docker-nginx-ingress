...
RUN yum -y update
RUN yum -y install wget ca-certificates epel-release python2-certbot-nginx
...
# Register the certbot
RUN certbot update_account --agree-tos -m lubos@klokner.sk -n
